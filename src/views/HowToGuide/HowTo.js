        ...
        <div>
          <div className={classes.container}>
                ...
                <div className={classes.profile}>
                  ...
                  <div className={isDesktop ? classes.placeOne : classes.placeOneM}>
                  ...
                  <div className={isDesktop ? classes.placeTwo : classes.placeTwoM}>
                    
                    <div className={ isDesktop ? classes.BodyTextAion : classes.BodyTextAionM}>
                    {isDesktop ?
                    <div>
                    <h3>The Open Application Network is a foundation focusing on providing infrastructure and developing solutions for the gig economy.
                       Independent workers paid by the gig are fast becoming the norm. What used to seem like an after-work side hustle is frequently becoming the main source of income for many savvy individuals. With this, comes many problems that did not previously exist. The Open Application Network plans to solve these.    </h3><br/>
                    <h3>We were involved in The Open Application Network since inception. Early, in the beginning, we had a role in the Aion User Advisory Board 
                      helping provide a voice for the community and test features before being released. During the transition in 2019 Aion(the underlying token powering the OAN) went through a consensus upgrade making it a unique hybrid POS/POW consensus. From the hard fork, we have operated a low fee
                        community node to help keep the protocol decentralized and are actively looking at other options to excel growth within the network</h3>  
                    </div>
                    :
                    <div>
                    <h4>The Open Application Network is a foundation focusing on providing infrastructure and developing solutions for the gig economy.
                       Independent workers paid by the gig are fast becoming the norm. What used to seem like an after-work side hustle is frequently becoming the main source of income for many savvy individuals. With this, comes many problems that did not previously exist. The Open Application Network plans to solve these.  </h4><br/>
                    <h4>We were involved in The Open Application Network since inception. Early, in the beginning, we had a role in the Aion User Advisory Board 
                      helping provide a voice for the community and test features before being released. During the transition in 2019 Aion(the underlying token powering the OAN) went through a consensus upgrade making it a unique hybrid POS/POW consensus. From the hard fork, we have operated a low fee
                        community node to help keep the protocol decentralized and are actively looking at other options to excel growth within the network</h4> 
                    </div>
                    
                    }
                    {isDesktop ?
                     <a href="https://theoan.com/"> <div className={classes.AionLogo}><img src={profile} alt="..."  className={classes.image} /> </div>
                     </a>:
                      <a href="https://theoan.com/"> <div className={classes.AionLogoM}><img src={profile} alt="..."  className={classes.image} /> </div>
                      </a>
                      }     
                    </div>
